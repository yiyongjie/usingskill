...
public class FreemarkUtil {
    private static final String MODEL_PATH = "src/main/java/com/skill/model";
    private static final String MAPPER_PATH = "src/main/java/com/skill/dao";
